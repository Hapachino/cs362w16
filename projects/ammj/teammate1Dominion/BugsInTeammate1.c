 ...
 * 	ALL tests passed
 *
 * unittest2.c - int updateCoins(int player, struct gameState *state, int bonus)
 * 	ALL tests passed
 *
 * unittest3.c - int shuffle(int player, struct gameState *state)4
 * 	ALL tests passed
 *
 * unittest4.c - int getWinners(int players[MAX_PLAYERS], struct gameState *state)
 ...
 *
 * cardtest1.c - int playSmithy(int handPos, struct gameState *state);
 * 	Bug2: Card not put onto played pile
 ...
 *
 * cardtest2.c - int playAdventurer(struct gameState *state);
 ...
 *
 * cardtest3.c - Baron Card using CardEffect
 * 	Bug8: card not put onto played pile
 ...
 * cardtest4.c - Tribute card using CardEffect
 * 	Bug13: More actions than expected sometimes added
 * 	Bug14: Card not added to played pile
 ...
 * randomtestcard.c - redid Baron Card
 * 	Previously reported Bug8: card not put onto played pile
 * 	Previously reported Bug9: Extra Card in hand after card played
 * 	Previously reported Bug10: Coin Bonus being not being updated
 * 	Previously reported Bug11: Coins added to state->coins which is wiped before coins updated in playCard() function
 * 	Previously reported Bug12: Estate supply loses more estates than expected when estate taken from supply
 ...
 *
 * randomTestAdventurer.c - playAdventurer random
 * Previously reported Bug5: Adventurer card not put on played pile
 * Previously reported Bug6: Extra Card in hand after card played
 * Previously reported Bug7: Unexpected amount of cards discarded when deckCount or discardCount is greater than 0
