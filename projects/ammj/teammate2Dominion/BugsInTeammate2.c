 ...
 * 	Bug13: Card not added to played pile
 ...
 * 	Previously reported Bug7: card not put onto played pile
 * 	Previously reported Bug8: Extra Card in hand after card played
 * 	Previously reported Bug9: Coin Bonus being not being updated
 * 	Previously reported Bug10: Coins added to state->coins which is wiped before coins updated in playCard() function
 * 	Previously reported Bug11: Estate supply loses more estates than expected when estate taken from supply
 ...
 * Previously reported Bug4: Adventurer card not put on played pile
 * Previously reported Bug5: Extra Card in hand after card played
