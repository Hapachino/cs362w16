...
Gamestate
	...
	- Player 1 draws 5 cards and plays Adventurer card

Requirements to test
	- After Player 1 plays the adventurer card	
		- Player 1 should have 2 additional treasure cards in their hand, but minus the Adventurer card
		- Player 1's discard pile may have increased
		- Player 1's deck will go down by at least 2
		- Player 2 will be unaffected
