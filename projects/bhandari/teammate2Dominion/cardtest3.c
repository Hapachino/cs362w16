...
Gamestate
	...
	- Player 1 draws 5 cards and plays Village card

Requirements to test
	- After the village card is played
		- Player 1 will have the same amount of cards in hand (+1 from card draw, -1 from Village card discard)
		- Player 1 will have 2 action moves 
		- Player 1 will have 1 fewer in the deck
		- Player 2 is unchanged
		- Kingdom/Victory supply is unchanged
*/
#include "dominion.h"
