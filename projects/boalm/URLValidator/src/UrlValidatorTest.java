...
//	   System.out.println(urlVal.isValid("http://www.amazon.com"));
   ...
   public void loopOverSchemes() {
	   ...
	   for(int i = 0; i < testUrlSchemes.length; i++) {
		   testURL = "";
		   testURL = testURL + testUrlSchemes[i].item; 
		   loopOverAuthorities(testURL, testUrlSchemes[i].valid);
	   }
   }
   ...
   public void loopOverAuthorities(String testURL, boolean expectedResult) {
	   ...
	   for(int i = 0; i < testAuthorities.length; i++) {
		   String testURLTemp = testURL + testAuthorities[i].item; 
		   if(expectedResult && testAuthorities[i].valid) {
   ...
   public void loopOverPorts(String testURL, boolean expectedResult) {
	   ...
	   for(int i = 0; i < testPorts.length; i++) {
		   String testURLTemp = testURL + testPorts[i].item; 
		   if(expectedResult && testPorts[i].valid) {
   ...
   public void loopOverPaths(String testURL, boolean expectedResult) {
	   ...
	   for(int i = 0; i < testPaths.length; i++) {
		   String testURLTemp = testURL + testPaths[i].item; 
		   if(expectedResult && testPaths[i].valid) {
   ...
   public void loopOverQueries(String testURL, boolean expectedResult) {
	   ...
	   for(int i = 0; i < testQueries.length; i++) {
		   String testURLTemp = testURL + testQueries[i].item; 
		   if(expectedResult && testQueries[i].valid) {
