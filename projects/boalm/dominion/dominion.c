...
int remodel(currentPlayer, choice1, state, choice2, handPos) {
  int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case council_room:
      return council_room(currentPlayer, state, handPos);
    ...
    case remodel:
      return remodel(currentPlayer, choice1, state, choice2, handPos)
		
    case smithy:
      return smithy(state, handPos, currentPlayer);
