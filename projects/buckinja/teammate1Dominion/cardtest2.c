...
void testAdventurer(struct gameState *G, int cardsInPlay[10]) {
    ...
    if (cards == G->discardCount[player]) {
        ...
        printf("testAdventurer(): NEW FAIL wrong number of cards were discarded to player's discard pile. Expected %d, found %d.\n", cards, G->discardCount[player]);
    }
    if (numTreasure == numTreasureAfter +2) {
        printf("testAdventurer(): PASS correct number of treasure cards removed from deck.\n");
    } else {
        printf("testAdventurer(): NEW FAIL wrong number of treasure cards removed from deck. Expected %d, found %d.\n", 2, numTreasure - numTreasureAfter);
    }
    if(numberInDeck == G->deckCount[player] + 2) {
        ...
        printf("testAdventurer(): NEW FAIL wrong number of total cards removed from correct player's deck. Expected %d, found %d.\n", numberInDeck-2, G->deckCount[player]);
    }
    ...
    if (numberInHand == G->handCount[player] - 2){
        ...
        printf("testAdventurer(): NEW FAIL wrong number of total cards in hand. Expected %d, found %d.\n", numberInHand +2, G->handCount[player]);
    }
    ...
    if(numberInHand == G->handCount[player] -2) {
        ...
        printf("testAdventurer(): NEW FAIL wrong number of cards in hand. Expected %d, found %d.\n", numberInHand +2, G->handCount[player]);
    }
    for (i = 0; i < G->handCount[player]; i++) {
        if (G->hand[player][i] == copper) {
            numTreasureAfter++;
    ...
    if (numTreasureAfter == 2){
        ...
        printf("testAdventurer(): NEW FAIL wrong number of treasure cards in hand. Expected 2, found %d.\n", numTreasureAfter);
    }
    int altered = 1;
    for (i = 0; i < 10; i++) {
