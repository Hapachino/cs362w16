...
void testAdventurer(struct gameState *G, int cardsInPlay[10]) {
    ...
    if(numTreasure == numTreasureAfter +2) 
		...
		printf("testAdventurer(): NEW FAIL incorrect number of treasure cards removed from deck. Expected %d, found %d.\n", numTreasure-2, numTreasureAfter);
    if (numberInDeck == G->deckCount[player] + 2)
		...
		printf("testAdventurer(): NEW FAIL incorrect number of total cards removed from player's deck. Expected %d, found %d.\n", numberInDeck-2, G->deckCount[player]);
    ...
    if(numberInHand == G->handCount[player] - 2)
		...
		printf("testAdventurer(): NEW FAIL incorrect number of total cards in hand. Expected %d, found %d.\n", numberInHand +2, G->handCount[player]);
