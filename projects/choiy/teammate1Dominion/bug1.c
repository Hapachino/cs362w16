...
never discarded. (there is one test I did not test for becuase I am not sure how,
which is that what happens if there are not two treasure cards in the deck and discard,
that is something I can try later)
