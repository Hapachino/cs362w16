            ...
            for(v = copper; v <= gold; v++){
                ...
                for(p = 0; p < MAX_PLAYERS; p++){
                    if(p == i){
                        ...
                        if(G.playedCardCount != test.playedCardCount + 1){
                            if(DEBUG)
                                printf("A TEST FAILED: adventurer did not put a card into playedCards %d\n", i);
                            pass = 0;
                        }
                        ...
                        //check that the discard has no extra cards
                        if(G.discardCount[i] != test.discardCount[i]){
                            if(DEBUG)
                                printf("A TEST FAILED: adventurer did discarded a card for player %d\n", i);
                            pass = 0;
                        }
                ...
                for(p = 0; p < MAX_PLAYERS; p++){
                    if(p == i){
                        ...
                        if(G.playedCardCount != test.playedCardCount + 1){
                            if(DEBUG)
                                printf("B TEST FAILED: adventurer did not put a card into playedCards %d\n", i);
                            pass = 0;
                        }
                        if(G.playedCards[G.playedCardCount - 1] != adventurer){
                            if(DEBUG)
                        ...
                        //check that the discard pile now has all but two of the draw piles
                        if(G.discardCount[i] != test.discardCount[i] + test.deckCount[i] - 2){
                            if(DEBUG)
                ...
                for(p = 0; p < MAX_PLAYERS; p++){
                    if(p == i){
                        ...
                        if(G.playedCardCount != test.playedCardCount + 1){
                            if(DEBUG)
                                printf("C TEST FAILED: adventurer did not put a card into playedCards %d\n", G.playedCardCount);
                            pass = 0;
                        }
                        if(G.playedCards[G.playedCardCount - 1] != adventurer){
                            if(DEBUG)
                                printf("C TEST FAILED: adventurer did not discard adventurer card from the hand for player %d\n", i);
                            pass = 0;
                        }
