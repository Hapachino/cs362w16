...
#include "teammate1dominion.h"
#include "teammate1dominion_helpers.h"
  ...
  for (i = 0; i < adv_runs; i++){
    ...
    /***************************************************
      ...
      ***************************************************/
      ...
      printf("TEST6: Adventurer Hand Effects with 3 Treasures in Discard Pile\n");
      resetCards(&G,player);
