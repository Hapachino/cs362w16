...
int main() {
	...
	validationCheck = 1;
	printf("Number of actions before: %i\n", stateOriginal.numActions);
	printf("Number of actions after: %i\n", state.numActions);
