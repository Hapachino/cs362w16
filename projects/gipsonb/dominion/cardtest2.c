/* -----------------------------------------------------------------------
 * Unit test for Village Card. Pretty much identical to Smithy except with
 * the addition of actions. Again here we trust that discCard and drawCard
