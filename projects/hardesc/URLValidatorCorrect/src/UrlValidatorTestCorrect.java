 ...
 */
public class UrlValidatorTestCorrect extends TestCase {

   private boolean printStatus = false;
   private boolean printIndex = false;//print index that indicates current scheme,host,port,path, query test were using.

   public UrlValidatorTestCorrect(String testName) {
      super(testName);
   }
   ...
   public static void main(String[] argv) {
      ...
      UrlValidatorTestCorrect fct = new UrlValidatorTestCorrect("url test");
      fct.setUp();
      fct.testIsValid();
