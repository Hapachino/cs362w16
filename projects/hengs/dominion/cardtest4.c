...
int main() {
	...
	printf("TEST 1: choice1 = 0 = +4 cards, +1 buys, 1 additional card for every other player.\n");
	...
	printf("Player 1 buys = %d, expected = %d\n", testG.numBuys, G.numBuys + newBuy);
	//for player 2
	...
	//Player 2 handcount
	if(testG.handCount[player2] == G.handCount[player2] + 1){
	...
	//Player 2 deck Count
	if(testG.deckCount[player2] == G.deckCount[player2] - 1){
