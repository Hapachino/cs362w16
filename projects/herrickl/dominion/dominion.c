...
/********************************************************************
* My card functions start here - these are purposely buggy       
********************************************************************/
/********************************************************************
* Desc: current player gets 3 more card draws and smithy card is put
* into play through discard function.
* Parameters: int currentPlayer, struct gameState state, int handPos
********************************************************************/
int c_smithy(int currentPlayer, struct gameState *state, int handPos){
  int i;
  //for +3 cards
  for(i = 0; i <3; i++){
...
/********************************************************************
* Desc: current player gets 1 more card draw and two more actions,
* village card is put into play through discardCard function.
* Parameters: int currentPlayer, struct gameState state, int handPos
* int nextPlayer
********************************************************************/
int c_village(int currentPlayer, struct gameState *state, int handPos, int nextPlayer){
  //+1 Card
  drawCard(currentPlayer, state);
  //+2 Actions
...
/********************************************************************
* Desc: current player gets two coins added through the updateCoins
* function, all other players need to discard a copper from their
* hand.  If they cannot discard, they must reveal their entire hand.
* cutpurse is put into play through discardCard function.
* Parameters: int currentPlayer, struct gameState state, int handPos
********************************************************************/
int c_cutpurse(int currentPlayer, struct gameState *state, int handPos){
  int i, j, k;
...
/***************************************************************************
* Desc: current player draws until they have drawn two treassure cards, 
* all other cards are discarded
* Parameters: int drawntreassure, struct gameState state, int currentPlayer, 
* int cardDrawn, int temphand[], int z
***************************************************************************/
int c_adventurer(int drawntreasure, struct gameState *state, int currentPlayer, int cardDrawn, int temphand[], int z, int handPos){
...
/********************************************************************
* Desc: current player gets 4 more drawn cards and 1 more buy, 
* council_room is put into play through the discardCard function
* Parameters: int currentPlayer, struct gameState state, int handPos
********************************************************************/
int c_council_room(int currentPlayer, struct gameState *state, int handPos){
  int i;
