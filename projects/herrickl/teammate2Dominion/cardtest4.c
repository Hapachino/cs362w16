...
int main(){
	...
	cardEffect(outpost, 0, 0, 0, &Test, 0, 0);

	//print info from test case
	printf("\n%d. Did player 1's hand change:\n", testNum);
	if(Test.handCount[p1] == Clean.handCount[p1]) { //acount for discard of council_room
	...
	testNum++;
	printf("\n%d. Did the outpost played change + 1:\n", testNum);
	if(Test.outpostPlayed == Clean.outpostPlayed+1){
		printf("Passed. Outpost played is %d + 1 = %d\n", Clean.outpostPlayed, Test.outpostPlayed);
	}
	else{	//fail
		printf("Failed. Outpost played is %d + 1 = %d\n", Clean.outpostPlayed, Test.outpostPlayed);
	}
	testNum++;
	...
	if(Test.numActions == Clean.numActions+1){
		printf("Passed. Numbers of actions is %d + 1 = %d\n", Clean.numActions, Test.numActions);
	}
	else{	//fail
		printf("Failed. Phase is %d + 1 = %d\n", Clean.numActions, Test.numActions);
	}
	testNum++;
	...
	testNum++;
	printf("\n%d. Did the number of buys change':\n", testNum);
	if(Test.numBuys == Clean.numBuys){
		printf("Passed. Number of buys is %d = %d\n", Clean.numBuys, Test.numBuys);
	}
	else{	//fail
		printf("Failed. Number of buys is %d = %d\n", Clean.numBuys, Test.numBuys);
	}
	testNum++;
