...
public class UrlValidatorTest extends TestCase {
   ...
   {
	   UrlValidator urlVal = new UrlValidator(null, null, UrlValidator.ALLOW_ALL_SCHEMES);
	   boolean result = urlVal.isValid("http://www.amazon.com/test?hello=there");
	   
	   if (result != true)
	   {
		   System.out.println("Error in testYourFirstPartition");
	   }
   }
   
   public void testYourSecondPartition(){
	   UrlValidator urlVal = new UrlValidator(null, null, UrlValidator.ALLOW_ALL_SCHEMES);
	   boolean result = urlVal.isValid("ftp://255.253.251.255:80");
	   
	   if (result != true)
	   {
		   System.out.println("Error in testYourSecondPartition");
	   }
   }
   
   public void testYourThirdPartition(){
	   UrlValidator urlVal = new UrlValidator(null, null, UrlValidator.ALLOW_ALL_SCHEMES);
	   boolean result = urlVal.isValid("http://www.google.p:9034");
	   
	   if (result != false)
	   {
		   System.out.println("Error in testYourThirdPartition");
	   }
   }
   ...
   public void fillTestArrays(List<testObj> test_protocols, List<testObj> test_mains,
	   ...
	   testObj main6 = new testObj(true, "www.amazon.uk", "Main: .uk host with WWW");
