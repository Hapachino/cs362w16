...
public class UrlValidatorTest extends TestCase {
	...
	public void testIsValid(Object[] testObjects, long options) {
		...
		do {
			...
			for (int testPartsIndexIndex = 0; testPartsIndexIndex < testPartsIndex.length; ++testPartsIndexIndex) {
				// this loop builds the url string from the combination of url
				// elements referenced by the indexes
			...
			boolean result = urlVal.isValid(url); // method called here
	...
	public void testValidator202() {
		...
		assertTrue(urlValidator
				.isValid("http://www.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.logoworks.comwww.org"));
	}
	 ...
	 * <scheme>://<authority><path>?<query> except that the port number is
	 * broken out of authority to increase the number of permutations. A
	 * complete URL is composed of a scheme+authority+port+path+query, all of
	 * which must be individually valid for the entire URL to be considered
	 * valid.
	 */
	...
	ResultPair[] testUrlAuthority = { new ResultPair("www.google.com", true),
			...
			new ResultPair("go.a", false), new ResultPair("go.a1a", false),
			new ResultPair("go.cc", true), new ResultPair("go.1aa", false),
