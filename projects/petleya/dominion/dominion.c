...
int adven(struct gameState *state, int handPos, int currentPlayer, int drawntreasure, int cardDrawn){
...
int council(struct gameState *state, int handPos, int currentPlayer){
    int i; 
	for (i = 0; i < 4; i++)
	{
	  drawCard(currentPlayer, state);
...
int vill(struct gameState *state, int handPos, int currentPlayer){
      drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
		adven(state, handPos, currentPlayer, drawntreasure, cardDrawn);
      return 0;
			
    case council_room:
		council(state, handPos, currentPlayer);
      //+4 Cards
    ...
    case smithy:
      //+3 Cards
	smith(state, handPos, currentPlayer);
      return 0;

    case village:
	vill(state, handPos, currentPlayer);
      return 0;
    ...
    case steward:
	stew(choice1, choice2, choice3, state, handPos, currentPlayer);
      return 0;
