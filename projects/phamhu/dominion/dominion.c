...
/* Implement village logic*/
void villageCard(int handPos, int currentPlayer, struct gameState *state)
{
      //+1 Card
      drawCard(currentPlayer, state);
...
/* Implement council room logic*/
void councilRoomCard(int handPos, int currentPlayer, struct gameState *state)
{
	int i;
    //+4 Cards
	for (i = 0; i < 4; i++)
...
void feastCard(int choice1, int handPos, int currentPlayer, struct gameState *state)
{
	int i;
   	int temphand[MAX_HAND]; 
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case feast:
		feastCard(choice1, handPos, currentPlayer, state);
      	return 0;
