/***************************************************************************
 ** cardtest2.c ( test of adventurer functions) 
 ** Jeremy Fischman
 ** 
 ** This program is a unit test of the playAdventurer() function.  It tests
 ** that playAdventurer() complies with the following business rules: 
 **
...
int main(){
  ...
  fprintf(f,"Testing playAdventurer() complete.  \n");
