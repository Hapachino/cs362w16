...
int remodelFunc(struct gameState *state, int currentPlayer, int choice1, int choice2, int handPos)
{
    int i; 
    int j; 
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case adventurer:
      ...
      return adventurerFunc(state, currentPlayer); 
    
    case council_room:
    
      return councilRoomFunc(currentPlayer, state, handPos); 
    ...
    case remodel:
      ...
      return remodelFunc(state, currentPlayer, choice1, choice2, handPos);
