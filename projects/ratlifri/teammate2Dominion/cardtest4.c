...
//    cardEffectMine(0, &testG, 4, copper, silver);
	...
	count = 4;
	r = testG.handCount[0];
    printf("test %d: mine p0 hand             ", testnum);
    if( r == count )
	...
	count = 5;
	r = testG.deckCount[0];
    printf("test %d: mine p0 deck             ", testnum);
    if( r == count )
        printf("pass: expected %d, result %d\n", count, r);
    else
        printf("FAIL: expected %d, result %d\n", count, r);
    ...
    printf("test %d: mine p0 discard          ", testnum);
    if( r == count )
        printf("pass: expected %d, result %d\n", count, r);
    else
        printf("FAIL: expected %d, result %d\n", count, r);
	...
	count = 5;
	r = testG.handCount[1];
    printf("test %d: mine p1 hand             ", testnum);
    if( r == count )
        printf("pass: expected %d, result %d\n", count, r);
    else
        printf("FAIL: expected %d, result %d\n", count, r);
	...
	count = 5;
	r = testG.deckCount[1];
    printf("test %d: mine p1 deck             ", testnum);
    if( r == count )
        printf("pass: expected %d, result %d\n", count, r);
    else
        printf("FAIL: expected %d, result %d\n", count, r);
    ...
    printf("test %d: mine p1 discard          ", testnum);
    if( r == count )
        printf("pass: expected %d, result %d\n", count, r);
    else
        printf("FAIL: expected %d, result %d\n", count, r);
