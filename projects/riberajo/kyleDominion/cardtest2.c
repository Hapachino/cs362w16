 ...
 */
 ...
 int unitTest1(int handPos, struct gameState *post, int p, int victoryCount, int kingdomCount, int k[]);
...
int main() {
  ...
  //   clear game state and initialize game
   ...
   // stack the deck with 3 copper 2 gold
   // add copper (4)
   stackDeck(&G, p, 0, G.deckCount[p]-2, copper);
   // add gold (6)
   stackDeck(&G, p, G.deckCount[p]-2, G.deckCount[p] , gold);
   /* ---------- END TEST CASE 1  ---------------*/
  ...
  test1 = unitTest1(handPos, &G, p, victoryCount, kingdomCount, k);
  passOrFail(test1);
...
int unitTest1(int handPos, struct gameState *post, int p, int victoryCount, int kingdomCount, int k[]) {
  ...
  // run fucntion int adventurerCard(struct gameState *state, int currentPlayer)
...
int unitTest2(int handPos, struct gameState *post, int p, int victoryCount, int kingdomCount, int k[]) {
  ...
  // run fucntionint adventurerCard(struct gameState *state, int currentPlayer)
