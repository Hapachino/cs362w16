...
void playAdventurer(struct gameState *state, int currentPlayer, int temphand[MAX_HAND], int cardDrawn, int drawntreasure, int z)
{
...
void playCutpurse(int handPos, int currentPlayer, struct gameState *state)
{
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
		playAdventurer(state, currentPlayer, temphand, cardDrawn, drawntreasure, z);
 //     while(drawntreasure<2){
 ...
 //     }
    ...
    case steward:
		playSteward(handPos, currentPlayer, state, choice1, choice2, choice3);
 //     if (choice1 == 1)
	//{
	//  //+2 cards
	//  drawCard(currentPlayer, state);
 ...
 //     discardCard(handPos, currentPlayer, state, 0);
    ...
    case cutpurse:
		playCutpurse(handPos, currentPlayer, state);
 //     updateCoins(currentPlayer, state, 2);
 //     for (i = 0; i < state->numPlayers; i++)
	//{
	//  if (i != currentPlayer)
