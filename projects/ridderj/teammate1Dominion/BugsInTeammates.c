...
Title:  Estate Supply Count Incorrect
...
Description
===========
   Estate supply count is deprecated by more then one on both
   choice 0 and 1  
...
--------------------------
   ...
   Can easily be reproduced by playing the card and choosing
   either 0 or 1 for the variable choice.

   Some other data information  
      Player 1 is playing the estate card
      CHOICE: 0 or 1
      Cards in Deck #: 80
      Hand Cards:# 90
      Discard Deck #: 58
...
Expected Results
----------------
   Estate Supply Count = 39


Actual Results
--------------
   Estate Supply Count = 38
...
on situation where choice 1 it's depcreated > the 1. Shouldn't
