...
int cutpurseEffect(int handPos, int currentPlayer, struct gameState *state){
	int i;
	int j;
	int k;
...
int embargoEffect(int choice1, int handPos, int currentPlayer, struct gameState *state){
	  //+2 Coins
...
int salvagerEffect(int choice1, int handPos, int currentPlayer, struct gameState *state){
	//+1 buy
    state->numBuys++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
		return adventurerEffect(drawntreasure, currentPlayer, state);
    case council_room:
      //+4 Cards
      for (i = 0; i < 4; i++)
	{
    ...
    case cutpurse:
		return cutpurseEffect(handPos, currentPlayer, state);
    case embargo: 
		return embargoEffect(choice1, handPos, currentPlayer, state);
    case outpost:
      //set outpost flag
      state->outpostPlayed++;
    ...
    case salvager:
      return salvagerEffect(choice1, handPos, currentPlayer, state);
    case sea_hag:
      for (i = 0; i < state->numPlayers; i++){
	if (i != currentPlayer){
