...
void processResults(struct gameState *testState, struct gameState *oldState, int cardChoice){
    ...
    printf("NOTE: The discard count below is incorrect due to a bug domcumented in bug1.c\n");
...
int main(int argc, char *argv[]){
    ...
    printf("\n\nNOTE: These tests are 'failing' (incorrect discard and coin counts) due to 2 known bugs that are documented in bug.c\n");
    return 0;
}
