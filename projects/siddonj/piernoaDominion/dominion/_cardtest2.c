...
void testPlayAdventurer() {
  ...
  r = 0;
  int failPlay = cardEffect(adventurer, 1,1,1, testGame, 0 ,&r);   // Don't put adventurer card in player 1's hand.
  ...
  failPlay = cardEffect(adventurer, 1,1,1, testGame, 0 ,&r);          // Play adventurer with empty deck.
  ...
  failPlay = cardEffect(adventurer, 1,1,1, testGame, 0 ,&r);          // Play adventurer with 1 copper in deck.
