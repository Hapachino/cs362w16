...
int main()
{
     ...
     for (i = 0; i < numTests;i++)
     {
          ...
          for (j = 0; j < 25; j++) //iterate through every possible card in the game except treasure map and seahag
          {
          ...
          ===============================================================*/
          for (j = 0; j < 25; j++) //iterate through possible combinations of every possible card in the game except treasuremap
          {
               for (m = 0; m < 25; m++)
               {
          ...
          ===============================================================*/
          for (j = 0; j < 25; j++) //iterate through possible combinations of every possible card in the game except treasuremap and sea hag
          {
               for (m = 0; m < 25; m++)
               {
                    for (l = 0; l < 25; l++)
