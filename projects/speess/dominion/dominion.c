...
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
    ...
    case smithy: /* ~~~~~~~~~ REFACTORED ~~~~~~~~~ */
      useSmithy(currentPlayer, state, handPos);

/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
	
    case village: /* ~~~~~~~~~ REFACTORED ~~~~~~~~~ */
      useVillage(currentPlayer, state, handPos);
...
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
    ...
    case great_hall: /* ~~~~~~~~~ REFACTORED ~~~~~~~~~ */
      useGreat_Hall(currentPlayer, state, handPos);
...
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
    ...
    case treasure_map:
      ...
      if (index > -1) { // found second treasure map
      ...
      // else if no second treasure_map found in hand
      return -1;
    }
