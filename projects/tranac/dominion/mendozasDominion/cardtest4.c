...
int main() {
	...
	int handpos = 0, choice1 = 0, choice2 = 0, choice3 = 0, bonus = 0; //added to run on her code
	int numPlayers = 3;
	int seed = 1004;
	...
	cardEffect(council_room, choice1, choice2, choice3, &G, handpos, &bonus); //still in cardeffect
