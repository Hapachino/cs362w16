 ...
 * cardtest2.c - unit test for Smithy Card. 
 *
...
void cardtest2_helper(struct gameState* test, struct gameState* control, int currentPlayer, bool shuffledCards);
...
int main()
{
	...
	// ----------- TEST 1: +3 cards from full player deck --------------
	printf("TEST 1: +3 cards from full player deck\n");
	...
	cardtest2_helper(&test, &control, currentPlayer, false);

	// ----------- TEST 2: +3 cards from full player deck --------------
	printf("TEST 2: +3 cards from empty player deck\n");
	//set currentPlayer's hand and deck
	control.hand[currentPlayer][0] = TESTCARD_VALUE;
	control.hand[currentPlayer][1] = copper;
	control.hand[currentPlayer][2] = duchy;
	...
	// compare results of test with expected results
	cardtest2_helper(&test, &control, currentPlayer, true);
