/******************************************************************************************************
 * CS362 - Assignment 3 - Unit Testing For Dominion - Spencer Winlaw
 * unittest2.c - unit test for isGameOver() 
 *
 * Basic Requirements of isGameOver()
 *  - Return 1 if the supply count for province is 0
 *	- Return 1 if any 3 supply counts are 0
 *  - Otherwise returns 0
 *	- Make no changes to game state
 *
 *****************************************************************************************************/
