 ...
 * unittest3.c - unit test for discardCard(). 
 *
 * Basic Requirements of discardCard()
 *  - Remove a given card from current players hand
 *	- Place discarded card played into current player's discard deck
 *  - Place discarded card played into current player's playedCards
