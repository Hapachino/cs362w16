 ...
 * unittest4.c - unit test for endTurn() 
 *
 * Basic Requirements of Smithy
 *  - Discard currentPlayer's hand to their discard deck
 *	- Reset gamestate attributes for next turn
 *  - Start next players turn by drawing their hand and updating coins
 *
 *****************************************************************************************************/
...
int main()
{
	...
	// ----------- TEST 1: discard currentPlayer hand, start next players turn --------------
