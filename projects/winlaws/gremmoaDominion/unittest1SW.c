 ...
 * unittest1.c - unit test for updateCoins() 
 *
 * Basic Requirements of updateCoins() 
 *  - Updates value of state->coins to reflect number of coins currently in a 
 *	  given players hand (including any bonus coins).
 *	- No other state changes should be made.
 *
 *****************************************************************************************************/
