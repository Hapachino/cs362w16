...
//refactored 5 cards (including Adventurer and Smithy)
...
int cardRemodel(struct gameState *state, int choice1, int choice2, int handPos)
{
   int i;
   int j;
   int currentPlayer = whoseTurn(state);
...
int cardMine(struct gameState *state, int choice1, int choice2, int handPos)
{
   int i;
   int j;
   int currentPlayer = whoseTurn(state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case mine:
      return cardMine(state, choice1, choice2, handPos);
		
    case remodel:
      return cardRemodel(state, choice1, choice2, handPos);
