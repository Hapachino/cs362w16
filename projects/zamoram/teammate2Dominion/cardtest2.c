...
int testAdventurer(struct gameState *post, int p, int handPos)
{
	...
	playCardAdventurer(post, p, handPos);
...
int main()
{
	...
	SelectStream(2);
	PutSeed(3);
	printf("Testing playCardAdventurer() cardtest2.\n");
	...
	for(k = 0; k < numTests; k++)
	{
		...
		testAdventurer(&G, p, handPos);
		
	}
	
	printf("playCardAdventurer TESTS FINISHED.\n\n");
